...
export async function interactDefaults(data, toAlignId, defaultType) {
    try {
        ...
        let res = await interactOnchain(defaultFormat.interactionTypeKey, toAlignId, uploadResult.cid);
        return res;
    }
    catch (error) {
