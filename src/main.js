...
export async function interactDefaults(data, toAlignId, defaultType, account) {
    try {
        ...
        let res = await interactOnchain(defaultFormat.interactionTypeKey, toAlignId, uploadResult.cid, account);
        return res;
    }
    catch (error) {
